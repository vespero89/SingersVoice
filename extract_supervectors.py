...
featureset = 'SCAT_new_N=8000_T=1000'
filetype = 'htk'

# TODO ADD ROOTDIR PARAM
root_dir = os.path.realpath('/media/fabio/DATA/Work/Snoring/Snoring_Project/Snore_Classification')
targePath = os.path.join(root_dir, 'experiments', 'gmmUbmSvm')
...
def process_subfold(sf, fold):
    ...
    for m in mixtures:
        ...
        for seq in trainset:
            ...
            svFilePath = os.path.join(curSupervecSubPath, os.path.splitext(os.path.basename(seq[0]))[0])
